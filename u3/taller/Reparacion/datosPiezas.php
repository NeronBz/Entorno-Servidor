                ...
                <tbody>
                    ...
                    foreach ($piezas as $pr) {
                        ...
                        if (isset($_POST['modif']) and $_POST['modif'] == $pr->getP()->getCodigo()) {
                            ...
                            echo '<td> <input type="number" name="precio" step="0.01" disabled="disabled" value="' . $pr->getPrecio() . '"></td>';
                            echo '<td></td>';
                            echo '<td>';
                            ...
                            echo '<td>';
                            echo '<button type="submit" class="btn btn-outline-dark" name="modif" value="' . $pr->getP()->getCodigo() . '"><img src="../img/modif25.png"/></button>';
                            echo '<button type="button" class="btn btn-outline-dark" data-bs-toggle="modal" data-bs-target="#a' . $pr->getP()->getCodigo()
                                . '" name="avisar" value="' . $pr->getP()->getCodigo() . '"><img src="../img/delete25.png"/></button>';
                            echo '</td>';
                        }
                        echo '</tr>';
