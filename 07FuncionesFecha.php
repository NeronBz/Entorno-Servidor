...
//Mostrar fecha actual con formato pero usando la función time que devuelve el instante actual
...
//Sumar 1 día(representado en segundos (24*60*60)) al momento actual(time())
