                ...
                <tbody>
                    ...
                    foreach ($piezas as $p) {
                        ...
                        if (isset($_POST['modif']) and $_POST['modif'] == $p->getCodigo()) {
                            ...
                            echo '<td> <input type="text" name="codigo" maxlength="3" value="' . $p->getCodigo() . '"></td>';
                            ...
                            echo '<td>';
                            echo '<button type="submit" class="btn btn-outline-dark" name="modif" value="' . $p->getCodigo() . '"><img src="../img/modif25.png"/></button>';
                            echo '<button type="button" class="btn btn-outline-dark" data-bs-toggle="modal" data-bs-target="#a' . $p->getCodigo() . '" name="avisar" value="' . $p->getCodigo() . '"><img src="../img/delete25.png"/></button>';
                            echo '</td>';
                        }
                        echo '</tr>';
